...
class DashboardFactory(object):
    ...
    def __init__(self, request):
        ...
        org_resource_id = request.matchdict.get(
...
class ChartFactory(object):
    ...
    def __init__(self, request):
        ...
        chart_id = request.matchdict.get("chart_id", request.GET.get("chart_id"))
...
class ChartAlertFactory(object):
    ...
    def __init__(self, request):
        ...
        alert_id = request.matchdict.get("alert_id", request.GET.get("alert_id"))
